                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-info btn-sm" style="border-radius: 50%;" data-toggle="modal" data-target="#update<?php echo $row['code'] ?>">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="functions.php" method="POST">
                                                                                ...
                                                                                <div class="modal-footer justify-content-between">
                                                                                    ...
                                                                                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#delete_modal<?php echo $row['code'] ?>">Delete</button>
                                                                                    ...
                                                                                    <div class="modal-dialog modal-sm modal-dialog-centered">
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-footer justify-content-between">
                                                                                                ...
                                                                                                <button type="submit" class="btn btn-outline-danger" name="delete_franchisee">Yes,
                                                                                                    Delete it</button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
