            ...
            <div class="flip-card">
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                <div class="flip-card-front">
                  <div class="tom" style="border-radius: 10px; width: 100%; height: 100%;
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100 d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/crisj.areglado" class="fb-links" target="_blank">
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/asilo.reyyy" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/nedz.baybay" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/paopaolopaoloo" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/ryanangelo.delacruz.5" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/bokaroids" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/kilarioronielks" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/chrichelle.miole" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/heyitscelyna" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/nefetinairatomas" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/wooopieee" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/melisa.manalili" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/mico.sanpablo" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/profile.php?id=100009599992606" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/PedroGrifino" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-1 ms-3">
                        <h5 class="font-size-16 text-white mb-1 text-decoration-underline">Leslie Jean Mana-ay</h5>
                        <small class="font-size-10 text-white mb-1">Accounting Specialist</small>
                      </div>
                    </div>
                    <div class="mb-1 pt-1 text-white motto text-center">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/lian.scumberge" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
              ...
              <div class="flip-card-inner" onmouseenter="playz();" onmouseleave="stopz();">
                ...
                <div class="flip-card-back">
                  <div class="card-body d-flex flex-column justify-content-between align-items-stretch h-100">
                    ...
                    <div class="btn btn-primary btn-md d-flex w-100 align-items-center justify-content-center">
                      <a href="https://www.facebook.com/markospis13" class="fb-links" target="_blank">
                        <i class="fab fa-facebook me-2"></i>
                        Profile
                      </a>
                    </div>
