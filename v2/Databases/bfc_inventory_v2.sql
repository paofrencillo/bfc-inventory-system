...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2023 at 09:59 AM
...
INSERT INTO `users` (`user_id`, `employee_name`, `email`, `user`, `pass`, `is_superuser`, `is_logged_in`, `otp`) VALUES
(2, 'Admin Account', 'clirrvino@gmail.com', 'admin', '$2y$10$hl0kcikUSDGAs00KsgTDwupTrFBH5HuFBMqjxiX7M//5dJZpTRAgC', '1', 0, '8882555');
