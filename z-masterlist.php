  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <h6 class="mb-0 mr-2">
      <?php
          ...
          $h = date('G');
          $user = $_SESSION['login_user2']['user'];
              ...
              <div class="modal-body">
                ...
                <input type="hidden" name="action" value="enroll">
                  ...
                  <div class="modal-footer justify-content-between px-0 mx-0">
                    <input type="hidden" name="employee_id" id="employee_id" value="<?php echo $_SESSION['login_user2']['user_id'];?>">
                    <button type="button" class="btn btn-default mx-0" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary mx-0" id="enroll-btn">Add Product</button>
                  </div>
                </form>
              </div>
            </div>
                  ...
                  <div class="row">  
                    ...
                    <div class="modal-footer justify-content-between col-sm-12 mx-0 pb-0 px-0">
                      ...
                      <div class="justify-content-around d-none" id="save-cancel-btns">
                        <input type="hidden" name="employee_id" id="employee-id-modal" value="<?php echo $_SESSION['login_user2']['user_id'];?>">
