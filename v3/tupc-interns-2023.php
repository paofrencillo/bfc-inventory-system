        ...
        <div class="container p-5">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-xl-3 col-sm-6 g-4">
              <div class="card">
                 <div class="tom"
                    style="border-radius: 10px; width: 100%; height: 100%; position: absolute; background-image: url(dist/img/tom-and-jerry-ching-cheng-hanji.gif); background-position: center; background-repeat: no-repeat; background-size: cover;">
                </div>
                <div class="card-body">
                  <div class="d-flex align-items-center">
